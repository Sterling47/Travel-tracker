...
const submitNewTrip = (e, userId, destinationsData) => {
    ...
    bookNewTrip(newTripObj)
        .then(data => (0,_dom__WEBPACK_IMPORTED_MODULE_0__.displayNewPendingTrip)(data, destinationsData))
        .catch(error => {
